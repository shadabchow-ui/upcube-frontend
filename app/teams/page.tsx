      ...
      {tab === 'how' ? (
        <div>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <CardShell
              title="Step 3 — Human review gates"
              subtitle="Small checks prevent big mistakes."
            >
              <ul className="list-disc space-y-1 pl-5 text-white/75">
            ...
            <CardShell
              title="Step 4 — Ship and reuse"
              subtitle="Once it works, make it a standard."
            >
              <ul className="list-disc space-y-1 pl-5 text-white/75">
        ...
        <div>
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            ...
            <CardShell
              ...
              subtitle="Avoid “monitor everything” models by default."
            >
            ...
            <CardShell
              title="Human-owned responsibility"
              subtitle="AI drafts; humans decide."
            >
